...
export default function Hero({
  ...
  return (
    <section className={`relative ${(eyebrow || heading || subtext || ctaLabel || ctaLink) && !imageFeatured ? "lg:h-screen py-20 lg:py-0" : "pt-20"} bg-white px-6 lg:px-8 ${video ? "video-section" : ""} hero-section`}>
      {bgimageurl && (
        <div
      ...
      {imageFounder || founderSocialLinks || founderName || founderTitle || founderText ? (
        ...
        <div className="relative mx-auto flex flex-col max-w-7xl justify-center h-full">
          ...
          {imageFeatured && (
            <ScrollReveal animation="fadeInUp" delay={120}>
              <div className="flex flex-col lg:flex-row pb-5 gap-4 lg:gap-8 items-center justify-center">
                {eyebrow || heading || subtext || ctaLabel || ctaLink ? (
                  ...
                  <div className="flex-1/2 mt-4 h-120 bg-white rounded-md overflow-hidden shadow-lg shadow-[#262263]/10 m-auto p-2 lg:p-3">
