  ...
  return (
    <>
      <main className="bg-white">
        ...
        />
        <div className="mx-auto max-w-7xl pt-60 px-6 sm:pt-54 lg:px-8">
          <div className="mt-8 bg-white/10 px-6 lg:px-8 relative mb-8" dangerouslySetInnerHTML={{ __html: service?.content ?? "<p>This service is coming soon.</p>" }} />
